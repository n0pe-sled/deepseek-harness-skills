...
Two points in this checklist may trigger escalation to [deep-verification.md](references/deep-verification.md):
...
- Apply class-specific checks from [bug-class-verification.md](references/bug-class-verification.md)
...
- **Bounds proof**: For integer/bounds issues, create an explicit algebraic proof using the template in [evidence-templates.md](references/evidence-templates.md). Verify: IF validation_check_passes THEN bounds_guarantee_holds.
...
See [evidence-templates.md](references/evidence-templates.md) for the full PoC template.
...
Apply all six gates from [gate-reviews.md](references/gate-reviews.md) and all 13 items from [false-positive-patterns.md](references/false-positive-patterns.md) to reach a verdict.
